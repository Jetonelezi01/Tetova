...
<head>
    ...
    <title>Studio Anida - Redakto Klientin</title>
...
<body>
        ...
        <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="studio_anida_shto_rezervim.php">Shto Rezervim</a></li>
    ...
    <div class="form-container">
        ...
        <form method="POST" action="studio_anida_redakto_klientin.php">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit_id'])) {
        ...
        if ($conn->query($sql_update) === TRUE) {
            echo "<script>alert('Të dhënat u përditësuan me sukses!'); window.location.href='studio_anida_shiko_rezervimet.php';</script>";
        } else {
