...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_id'])) {
    ...
    if ($conn->query($sql_delete) === TRUE) {
        echo "<script>alert('Rezervimi u fshi me sukses!'); window.location.href='studio_chanel_shiko_rezervimet.php';</script>";
    } else {
...
<head>
    ...
    <title>Studio CHANEL - Shiko Rezervimet</title>
    <style>
        /* Global styles */
        * {
            margin: 0;
...
<header>
    ...
    <nav>
        ...
        <li><a href="studiochanel_login.html">Studio</a></li>
            ...
            <li><a href="studio_chanel_admin.php">Beje Rezervimin</a></li>
        </ul>
    </nav>
</header>
...
<div class="form-container">
    ...
    <form method="POST" action="studio_chanel_shiko_rezervimet.php">
        ...
        <table class="reservation-table">
            <thead>
                <tr>
                    ...
                    <th>Borxhi</th>
                    <th>Koment</th>
                    <th>Veprime</th> <!-- Kolona e veprimeve -->
                </tr>
            </thead>
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="GET" action="studio_chanel_redakto_klientin.php" style="display:inline;">
                                <input type="hidden" name="edit_id" value="<?php echo $row['id']; ?>">
                                <input type="submit" value="Redakto" style="background-color: #ff6600; color: white; border: none; padding: 5px 10px; width:auto; cursor: pointer;">
                            </form>
                            <form method="POST" action="studio_chanel_shiko_rezervimet.php" style="display:inline;">
                                <input type="hidden" name="delete_id" value="<?php echo $row['id']; ?>">
                                <input type="submit" value="Fshi" style="background-color: red; color: white; border: none; padding: 5px 10px; width:auto; cursor: pointer; ">
                            </form>
